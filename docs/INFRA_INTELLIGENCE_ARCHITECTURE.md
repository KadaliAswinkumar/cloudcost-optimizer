...
- [INFRA_INTELLIGENCE_1_WEEK_SPRINT.md](./INFRA_INTELLIGENCE_1_WEEK_SPRINT.md)
- [INFRA_INTELLIGENCE_GTM_BACKLOG.md](./INFRA_INTELLIGENCE_GTM_BACKLOG.md)
- [AWS_INFRA_INTELLIGENCE_IAM.md](./AWS_INFRA_INTELLIGENCE_IAM.md) (read-only IAM for live AWS collection)
